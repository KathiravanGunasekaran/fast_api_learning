...
@router.post("/api/v1/posts", status_code=status.HTTP_201_CREATED, response_model=PostResponse)
...
@router.get("/api/v1/posts/{id}", response_model=PostResponse)
...
@router.put("/api/v1/posts/{id}", response_model=PostResponse)
